...
export const jobsData = [
  {
    imgLink: salesken,
    jobTitle: "UX Intern - Native Application Redesign",
    companyName: "Salesken.ai",
    desc: "Led competitive research and designed user-focused interfaces at Salesken.ai, streamlining sales workflows with AI-driven tools and actionable insights.",
    linkTo: "/salesken",
  },
  {
    imgLink: bliveCover,
    jobTitle: "UX Intern - Application Redesign",
    companyName: "BLive EZY Application Redesign",
