import Brandshark_title from "../assets/Brandshark_title.png";
import Brandshark_wireframe from "../assets/Brandshark_wireframe.png";
import brandshark_compare from "../assets/brandshark_compare.png";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        id="project-image"
      >
        <img src={brandshark_compare} className="rounded-3xl object-cover w-full" />
      </div>
